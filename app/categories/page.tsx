...
export default function CategoriesPage() {
  ...
  if (!analytics) {
    return <div className="rounded-md bg-white p-6 text-sm text-slate-500 shadow-sm">Loading categories...</div>;
  }

  return (
    <div className="space-y-6">
      <div>
        <p className="text-sm font-medium text-brand-700">Organized sections</p>
