...
import { isJasonDemoOwnerEmail } from "@/lib/profile/avatar";
...
export default function ProfilePage() {
  ...
  const hasPermanentInitial = isJasonDemoOwnerEmail(profile?.email);
      ...
      <section className="rounded-md border border-slate-200 bg-white p-5 shadow-sm">
        ...
        {hasPermanentInitial ? (
          <p className="mt-6 rounded-md bg-slate-50 p-3 text-sm text-slate-600">
            El avatar permanente de esta cuenta demo es J.
          </p>
        ) : (
          <>
