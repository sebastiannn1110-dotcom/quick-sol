...
const MEMBERS: OrganizationMember[] = [
  member("jason", null, "Jason Boss — DEMO", "Chief Executive Officer — DEMO", "owner", "Executive — DEMO", "Singapore", "admin"),
  member("olivia", "jason", "Olivia Mercer — DEMO", "Chief Operating Officer — DEMO", "executive", "Executive — DEMO", "United States", "admin"),
...
describe("Team Structure filters and compensation", () => {
  ...
  it("combines filters, keeps only required ancestors, and clears every filter", async () => {
    ...
    expect(within(treeSection).getByText("Jason Boss — DEMO")).toBeTruthy();
  ...
  it.each([
    ...
    const fetchMock = vi.fn((input: RequestInfo | URL) => {
      ...
      if (url === "/api/organization/compensation/jason") {
