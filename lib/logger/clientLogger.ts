...
export const clientLogger = {
  ...
  uploadResumableBlockedOrFailed: (metadata?: Record<string, unknown>) =>
    sendClientLog("error", "resumable_upload_blocked_or_failed", "Resumable upload was blocked or failed", metadata),
