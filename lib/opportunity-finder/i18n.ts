...
const copy = {
  es: {
    ...
    description: "Compara dos archivos o busca con uno contra la base QuikSol autorizada, con coincidencias exactas de MPN y sin doble conteo.",
    ...
    errors: {
      ...
      DATASET_LOOKUP_FAILED: "No se pudo consultar la base QuikSol autorizada.",
  ...
  en: {
    ...
    description: "Compare two files or search with one against the authorized QuikSol dataset, with exact MPN matching and no double counting.",
    ...
    errors: {
      ...
      DATASET_LOOKUP_FAILED: "The authorized QuikSol dataset could not be queried.",
  ...
  zh: {
    eyebrow: "销售工具",
    title: "销售机会查找器",
    description: "比较两个文件，或使用一个文件在获授权的 QuikSol 数据库中搜索；精确匹配 MPN，且不会重复分配。",
    ...
    errors: {
      ...
      DATASET_LOOKUP_FAILED: "无法查询获授权的 QuikSol 数据集。",
