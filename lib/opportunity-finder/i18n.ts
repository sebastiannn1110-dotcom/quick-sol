...
const copy = {
  es: {
    ...
    description: "Compara dos archivos o busca con uno contra la base autorizada de Electronic Parts, con coincidencias exactas de MPN y sin doble conteo.",
    ...
    errors: {
      ...
      FILES_REQUIRED_FOR_COMPARISON_MODE: "Selecciona la cantidad de archivos requerida por el modo elegido.",
      DATASET_SUMMARY_NOT_READY: "La base autorizada todavía está actualizando sus resúmenes. Inténtalo nuevamente en unos minutos.",
      DATASET_LOOKUP_FAILED: "No se pudo consultar la base autorizada de Electronic Parts.",
      DATASET_SNAPSHOT_FAILED: "No se pudo guardar el snapshot reproducible de la base autorizada.",
  ...
  en: {
    ...
    description: "Compare two files or search with one against the authorized Electronic Parts dataset, with exact MPN matching and no double counting.",
    ...
    errors: {
      ...
      FILES_REQUIRED_FOR_COMPARISON_MODE: "Select the number of files required by the chosen mode.",
      DATASET_SUMMARY_NOT_READY: "The authorized dataset is still updating its summaries. Try again in a few minutes.",
      DATASET_LOOKUP_FAILED: "The authorized Electronic Parts dataset could not be queried.",
      DATASET_SNAPSHOT_FAILED: "The reproducible authorized-dataset snapshot could not be saved.",
  ...
  zh: {
    eyebrow: "销售工具",
    title: "销售机会查找器",
    description: "比较两个文件，或使用一个文件在获授权的 Electronic Parts 数据库中搜索；精确匹配 MPN，且不会重复分配。",
    ...
    errors: {
      ...
      FILES_REQUIRED_FOR_COMPARISON_MODE: "请选择所选模式需要的文件数量。",
      DATASET_SUMMARY_NOT_READY: "获授权的数据集仍在更新摘要，请稍后重试。",
      DATASET_LOOKUP_FAILED: "无法查询获授权的 Electronic Parts 数据集。",
      DATASET_SNAPSHOT_FAILED: "无法保存可复现的授权数据集快照。",
...
const WARNINGS: Record<Language, Record<OpportunityWarningCode, string>> = {
  es: {
    ...
    formula_cached_value_used: "Valor cacheado de fórmula utilizado sin ejecutar la fórmula",
  ...
  en: {
    ...
    formula_cached_value_used: "Cached formula value used without executing the formula",
  ...
  zh: {
    ...
    formula_cached_value_used: "未执行公式，已使用缓存值",
